...
class L2RMauiScheduler(EasyBackfillScheduler):

    def __init__(self, options, weights_list=None, weights_backfill=None):
        super(L2RMauiScheduler, self).__init__(options)
    ...
    def new_events_on_job_submission(self, just_submitted_job, current_time):
        ...
        self.maui_counter += 1
        return super(L2RMauiScheduler, self).new_events_on_job_submission(just_submitted_job, current_time)
    ...
    def _schedule_jobs(self, current_time):
        ...
        return super(L2RMauiScheduler, self)._schedule_jobs(current_time)
    ...
    def _backfill_jobs(self, current_time):
        ...
        result = super(L2RMauiScheduler, self)._backfill_jobs(current_time)
