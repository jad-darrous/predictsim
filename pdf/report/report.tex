...
New schemes for distributing resources are more present than ever. Many systems have complex network and memory/hard drive sharing topologies. Moreover, the topology of some HPC system can change on a hourly to monthly basis, as the supporting hardware of distributed systems can be reconfigured or extended continually.
...
In addition, the data (i.e.\ the characteristics of the tasks to be executed on the system) these systems have to work with presents many peculiarities.
