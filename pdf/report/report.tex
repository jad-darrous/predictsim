...
High Performance Computing (HPC) systems are complex machinery at the frontier between research in scheduling and systems engineering. We outline the two main difficulties that resource management software in this field have to face.
