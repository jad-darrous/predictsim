...
Usage:
    predictor.py <filename> <extracted_data> <output_folder> randomforest <encoding> [-i] [-v]
    predictor.py <filename> <extracted_data> <output_folder> tsafrir [-i] [-v]
    predictor.py <filename> <extracted_data> <output_folder> svr <encoding> [-i] [-v]
    predictor.py <filename> <extracted_data> <output_folder> sgd <loss> <penalty> <encoding> <max_runtime> <max_cores> [-i] [-v]
    predictor.py <filename> <extracted_data> <output_folder> passive-aggressive <loss> <encoding> <max_runtime> <max_cores> [-i] [-v]
