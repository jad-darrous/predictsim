...
#parser to load experiment result files.
parser_rf<-function(description,epilog){
	parser<-parser_common(description,epilog)
	parser$add_argument('filename',nargs='+',metavar='FILE',type='character', help='input swf file(s)')
	return(parser)
}
